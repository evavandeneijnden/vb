...
public class Checker extends SimplePascalBaseListener {
    ...
    @Override
    public void exitIntType(@NotNull SimplePascalParser.IntTypeContext ctx) {
        setType(ctx, Type.INT);
        setEntry(ctx, ctx);
    }

    @Override
    public void exitBoolType(@NotNull SimplePascalParser.BoolTypeContext ctx) {
        setType(ctx, Type.BOOL);
        setEntry(ctx, ctx);
    }
    ...
    @Override
    public void exitVar(@NotNull SimplePascalParser.VarContext ctx) {
        setEntry(ctx, ctx);
    ...
    @Override
    public void exitBlockStat(@NotNull SimplePascalParser.BlockStatContext ctx) {
    ...
    @Override
    public void exitInStat(@NotNull SimplePascalParser.InStatContext ctx) {
        setEntry(ctx, ctx);
    ...
    @Override
    public void exitOutStat(@NotNull SimplePascalParser.OutStatContext ctx) {
        setEntry(ctx, ctx);
    }
