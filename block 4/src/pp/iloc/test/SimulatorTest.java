...
public class SimulatorTest {
	...
	public void testFig13() {
		Program p = parse("C:\\Users\\Eva\\Documents\\vb\\block 4\\src\\pp\\iloc\\sample\\fig1-3");
		Machine c = new Machine();
		System.out.println("a" + c.getNum("a"));
		int a = c.init("a", 2);
		c.init("b", 3);
		c.init("c", 4);
		c.init("d", 5);
	...
	public void testFig13Stack() {
		Program p = parse("C:\\Users\\Eva\\Documents\\vb\\block 4\\src\\pp\\iloc\\sample\\fig1-3-stack");
		Machine c = new Machine();
		int a = c.init("a", 2);
		c.init("b", 3);
		c.init("c", 4);
	...
	public void testFig13Init() {
		Program p = parse("C:\\Users\\Eva\\Documents\\vb\\block 4\\src\\pp\\iloc\\sample\\fig1-3-init");
		Machine c = new Machine();
	...
	public void testString() {
		Program p = parse("C:\\Users\\Eva\\Documents\\vb\\block 4\\src\\pp\\iloc\\sample\\string");
	...
	public void testStringChar4() {
		Program p = parse("C:\\Users\\Eva\\Documents\\vb\\block 4\\src\\pp\\iloc\\sample\\string4");
		Simulator sim = new Simulator(p);
