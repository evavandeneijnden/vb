...
public class CC5AttrParser extends Parser {
	...
	public static class TermContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5AttrVisitor ) return ((CC5AttrVisitor<? extends T>)visitor).visitTerm(this);
					...
					case 1:
						...
						((TermContext)_localctx).term1 = term(8);
						   if (((TermContext)_localctx).term0.type == Type.NUM && ((TermContext)_localctx).term1.type == Type.NUM){
						                      ...
						                      else if (((TermContext)_localctx).term0.type == Type.STR && ((TermContext)_localctx).term1.type == Type.NUM) {
						                              ((TermContext)_localctx).type =  Type.STR;
						                       }
						                       else {
	...
	public static final String _serializedATN =
		...
		"\3\2\2\3\2\3\2\2\2+\2\20\3\2\2\2\4\5\b\2\1\2\5\6\7\5\2\2\6\7\5\2\2\2\7"+
		"\b\7\6\2\2\b\t\b\2\1\2\t\21\3\2\2\2\n\13\7\13\2\2\13\21\b\2\1\2\f\r\7"+
		"\b\2\2\r\21\b\2\1\2\16\17\7\n\2\2\17\21\b\2\1\2\20\4\3\2\2\2\20\n\3\2"+
		"\2\2\20\f\3\2\2\2\20\16\3\2\2\2\21#\3\2\2\2\22\23\f\t\2\2\23\24\7\4\2"+
		"\2\24\25\5\2\2\n\25\26\b\2\1\2\26\"\3\2\2\2\27\30\f\b\2\2\30\31\7\t\2"+
