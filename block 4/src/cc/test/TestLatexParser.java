...
public class TestLatexParser {
    ...
    public void test(){
        ...
        file_test("./src/cc/tabular/tabular-1.tex",true);
        file_test("./src/cc/tabular/tabular-2.tex",true);
        file_test("./src/cc/tabular/tabular-3.tex",true);
        file_test("./src/cc/tabular/tabular-4.tex",false);
        file_test("./src/cc/tabular/tabular-5.tex",true);
    }
