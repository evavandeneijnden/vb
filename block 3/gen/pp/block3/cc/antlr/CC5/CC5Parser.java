...
public class CC5Parser extends Parser {
	...
	public static class StrContext extends TermContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitStr(this);
	...
	public static class ParenthesesContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitParentheses(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BoolContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitBool(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NumContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitNum(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class EqualsContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitEquals(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class HatContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitHat(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PlusContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CC5Visitor ) return ((CC5Visitor<? extends T>)visitor).visitPlus(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\1\2\5\6\7\5\2\2\6\7\5\2\2\2\7\b\7\6\2\2\b\r\3\2\2\2\t\r\7\13\2\2\n"+
		"\r\7\b\2\2\13\r\7\n\2\2\f\4\3\2\2\2\f\t\3\2\2\2\f\n\3\2\2\2\f\13\3\2\2"+
		"\2\r\31\3\2\2\2\16\17\f\t\2\2\17\20\7\4\2\2\20\30\5\2\2\n\21\22\f\b\2"+
		"\2\22\23\7\t\2\2\23\30\5\2\2\t\24\25\f\7\2\2\25\26\7\7\2\2\26\30\5\2\2"+
